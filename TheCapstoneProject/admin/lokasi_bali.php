...
{
    global $koneksi;
    $sql = "SELECT foto1, foto2, foto3, foto4, foto5, foto6 FROM bali WHERE id = '$id'";
...
if ($op == 'delete' && isset($_GET['id'])) {
    ...
    $sql1 = "DELETE FROM bali WHERE id = '$id'";
...
<h1>Admin Pulau Bali</h1>
<p>
    <a href="input_bali.php">
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1 = "SELECT * FROM bali $sqltambahan";
