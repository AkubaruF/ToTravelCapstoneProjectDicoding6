...
if ($op == 'delete' && isset($_GET['id'])) {
    ...
    $sql1 = "DELETE FROM sumatera WHERE id = '$id'";
...
<h1>Admin Pulau Sumatera</h1>
<p>
    <a href="input_sumatera.php">
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1 = "SELECT * FROM sumatera $sqltambahan";
        ...
        <tr>
            ...
            <?php
                    ...
                    ?>
            <td>
                <a href="input_sumatera.php?id=<?php echo $r1['id']; ?>"><span
                        class="badge text-bg-warning">Edit</span></a>
                <a href="lokasi_sumatera.php?op=delete&id=<?php echo $r1['id']; ?>"
