...
{
    global $koneksi;
    $sql = "SELECT foto1, foto2, foto3, foto4, foto5, foto6 FROM jawa WHERE id = '$id'";
...
if ($op == 'delete' && isset($_GET['id'])) {
    ...
    $sql1 = "DELETE FROM jawa WHERE id = '$id'";
...
<h1>Admin Pulau Jawa</h1>
<p>
    <a href="input_jawa.php">
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1 = "SELECT * FROM jawa $sqltambahan";
        ...
        <tr>
            ...
            <?php
                    ...
                    ?>
            <td>
                <a href="input_jawa.php?id=<?php echo $r1['id']; ?>"><span class="badge text-bg-warning">Edit</span></a>
                <a href="lokasi_jawa.php?op=delete&id=<?php echo $r1['id']; ?>"
