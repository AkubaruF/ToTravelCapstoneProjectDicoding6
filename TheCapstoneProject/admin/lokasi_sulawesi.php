...
{
    global $koneksi;
    $sql = "SELECT foto1, foto2, foto3, foto4, foto5, foto6 FROM sulawesi WHERE id = '$id'";
...
if ($op == 'delete' && isset($_GET['id'])) {
    ...
    $sql1 = "DELETE FROM sulawesi WHERE id = '$id'";
...
<h1>Admin Pulau Sulawesi</h1>
<p>
    <a href="input_sulawesi.php">
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1 = "SELECT * FROM sulawesi $sqltambahan";
        ...
        <tr>
            ...
            <?php
                    ...
                    ?>
            <td>
                <a href="input_sulawesi.php?id=<?php echo $r1['id']; ?>"><span
                        class="badge text-bg-warning">Edit</span></a>
                <a href="lokasi_sulawesi.php?op=delete&id=<?php echo $r1['id']; ?>"
