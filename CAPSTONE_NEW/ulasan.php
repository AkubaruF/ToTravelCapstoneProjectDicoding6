...
<body>
  ...
  <main class="content">
    <section class="input_section">
        ...
        <form id="input" method="post" enctype="multipart/form-data">
            <div class="input">
                ...
                <input name="nama" id="nama" type="text" minlength="10" aria-describedby="titleValidation" required>
            </div>
            <div class="input">
            ...
            <button name="simpan" id="bookSubmit" type="submit">Submit</button>
        </form>
    </section>
    ...
    <section class="book_shelf">
      ...
      <div id="incompleteNoteboardList" class="book_list">
        <?php
          // Include file koneksi
          include ("inc/inc_koneksi.php");
          $id = $_GET['id'];
